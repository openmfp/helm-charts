...
kubectl create secret generic portal-client-secret-openmfp -n openmfp-system --from-literal=attribute.client_secret=$kkSecret --dry-run=client -o yaml | kubectl apply -f -
